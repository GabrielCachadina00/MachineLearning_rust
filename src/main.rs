...
fn main() {
    ...
    let mut layer1 = neuron_ops::layer_creation(2,3,"relu");//layer neurons,next layer neurons,activation
    let mut layer2 = neuron_ops::layer_creation(3,1,"sigmoid");//layer neurons,next layer neurons,activation
    ...
    layer2 = neuron_ops::weight_init_0s(layer2); //Initialize to 0s
